  ...
  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="border-b border-gray-900/10 pb-12 ">
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-4">
          ...
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
              ...
              <input type="text" name="titulo" class="form-control block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" value="{{ old('titulo', $propiedades?->titulo) }}" id="titulo" placeholder="Titulo">
            </div>
          </div>
        </div>
        ...
        <div class="sm:col-span-4">
          <label for="cover-photo" class="py-1.5 block text-sm font-medium leading-6 text-gray-900">Cover photo</label>
          <h1>Subir imagen</h1>
          
        <!--  <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-16">
